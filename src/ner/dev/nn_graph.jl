...
function (nn::NN_Graph)(x::NamedTuple)
    ...
    for i = 1:4
        ...
        #g = avgpooling1d(h, x.dims_w, 7, padding=3)
        # g = dropout_g(g)
        #g = conv_g()
        #g = concat(1, g, g0)
        #g = nn.conv_g(g)
